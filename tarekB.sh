...
# ###########################################
#
# Command: wget -q "--no-check-certificate" https://raw.githubusercontent.com/tarekzoka/multistalker/main/tarekB.sh -O - | /bin/sh
#
# ###########################################
versions="1.4"
###########################################
...
URL='https://raw.githubusercontent.com/tarekzoka/multistalker/main'
